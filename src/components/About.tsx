    ...
    >
      ...
      <div className="max-w-6xl mx-auto px-6 relative z-20">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <div className="relative w-80 h-80 mx-auto lg:mx-0">
              ...
              <img
                src={avatarPlaceholder}
                alt="Sarab"
                className="relative w-full h-full object-cover rounded-full border-4 border-primary/20 shadow-card hover:scale-105 transition-transform"
              />
          ...
          >
            <div className="glass p-8 rounded-2xl">
              <h3 className="text-2xl font-semibold mb-4 bg-gradient-to-r from-purple-400 via-pink-400 to-indigo-400 bg-clip-text text-transparent">
                Hello, I'm Sarab! 👋
              </h3>
              ...
              <p className="text-lg leading-relaxed text-foreground/80 mb-6">
                ...
                <span className="font-medium bg-gradient-to-r from-pink-400 to-purple-500 bg-clip-text text-transparent">
              ...
              <p className="text-lg leading-relaxed text-foreground/80 mb-6">
                ...
                and have strong foundations in{" "}
                <span className="font-medium bg-gradient-to-r from-indigo-400 to-violet-500 bg-clip-text text-transparent">
                  AI, ML, and NLP research
                </span>
                .
              </p>
            ...
            <div className="grid grid-cols-3 gap-4">
              ...
              <div className="text-center glass p-4 rounded-xl">
                <div className="text-2xl font-bold bg-gradient-to-r from-yellow-300 via-orange-400 to-red-400 bg-clip-text text-transparent">
                  ∞
                </div>
                <div className="text-sm text-foreground/70">Coffee Cups</div>
              </div>
            </div>
          </motion.div>
        </div>
